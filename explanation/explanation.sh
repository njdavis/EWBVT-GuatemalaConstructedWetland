...
pandoc markdownWetlandNotes.txt  --from markdown+raw_tex+grid_tables --variable documentclass=article  --lua-filter insertCode.lua --filter pandoc-fignos --filter pandoc-tablenos  --filter pandoc-eqnos -o wetlandNotes.pdf
